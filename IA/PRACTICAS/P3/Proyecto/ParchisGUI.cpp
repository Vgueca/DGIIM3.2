...
ParchisGUI::ParchisGUI(Parchis &model)
    : RenderWindow(VideoMode(getInitialWindowWidth(), getInitialWindowHeight(), VideoMode::getDesktopMode().bitsPerPixel), L"Parchis", Style::Titlebar | Style::Close | Style::Resize),
